#!/usr/bin/env python
"""
Step 3 of the Part-B strengthening design (docs/part-b-strengthening-design.md):
pre-registered threshold calibration. Sweeps score_chains.py's threshold T over the
...
DEFAULT_SWEEP = tuple(round(t, 2) for t in np.arange(0.05, 0.96, 0.05))
