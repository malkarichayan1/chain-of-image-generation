#!/usr/bin/env python
"""
Part C, Step 1 (docs/part-c-validation-design.md) -- the validation gate. score_chains.py's
Phase A/C functions (delta_mask_from_sigmoid, iou_top_k) are a deliberate *port* of
pilot/spatial_semantic_alignment.py's SpatialSemanticAlignment class, not an import (see
...
from spatial_semantic_alignment import SpatialSemanticAlignment  # noqa: E402

from score_chains import delta_mask_from_sigmoid, iou_top_k  # noqa: E402
...
if __name__ == "__main__":
    ...
    if delta_mismatches or iou_mismatches:
        print("MISMATCH DETECTED -- see docs/part-c-validation-design.md Step 1 decision rule.")
        sys.exit(1)
