"""
Thin coverage for generate_chains.py (Stage 1), by design (docs/part-b-strengthening-
design.md's Testing section): only base_prompt_for and the manifest-schema assembly are
tested here. Model calls (image generation, detection, CLIP matching) stay untested --
