#!/usr/bin/env python
"""
Stage 2 of the Part-B strengthening design (docs/part-b-strengthening-design.md):
CLIPSeg segmentation, cached as raw sigmoid maps keyed by (image_path, attribute).
