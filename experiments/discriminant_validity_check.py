...
CONDITIONS_TO_CHECK = ("real", "attn_scrambled_samechain", "attn_scrambled_crosschain", "attn_scrambled_sameattr")


if __name__ == "__main__":
    import argparse

    ap = argparse.ArgumentParser(description="Part D2: does iou just track subject bbox size?")
