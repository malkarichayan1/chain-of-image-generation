...
Design note (Experiment 4): checked all 306 real scored rows in artifacts_sdxl/manifest.json --
nearest-subject equals intended_subject 306/306 times, because the current prompt template never
lets a second subject intervene between a subject and its own attribute. This baseline is still
exactly what was asked for and still a meaningful comparison; it just currently coincides with
"always guess the intended pairing."

NOT YET RUN ON REAL DATA. Run against the dummy fixture today:
