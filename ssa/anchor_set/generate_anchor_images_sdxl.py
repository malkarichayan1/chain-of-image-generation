...
# dataset input before now -- there is no existing convention to copy. Before pushing this
# script to backfill model_scores_full:
#   1. Upload the current artifacts_sdxl/manifest.json as a new private Kaggle dataset.
#   2. Add that dataset's slug to the kernel's "dataset_sources" config.
