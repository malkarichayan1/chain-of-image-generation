...
dataset, NOT regenerating them (diffusion output is not guaranteed bit-reproducible
across Kaggle sessions, unlike
...
def load_model():
    ...
    model = BlipForQuestionAnswering.from_pretrained(BLIP_VQA_MODEL).to(DEVICE).eval()
