...
manifest.json) so the existing human-labeled rows stay valid -- follow the same pilot
...
def load_all_models() -> Models:
    ...
    clip_model = CLIPModel.from_pretrained(CLIP_MODEL, use_safetensors=True).to("cpu").eval()
