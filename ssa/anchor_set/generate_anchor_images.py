#!/usr/bin/env python
"""
Stage 1 of the metric-A human-agreement anchor set: 18 compositional prompts (6 each at
n=2/3/4 subjects) -> one one-shot SD1.5 image each,
...
ANCHOR_PROMPTS = [
    ...
    # SDXL is the canonical model going forward -- kept in sync here so
...
# The SD1.5 set is frozen: the SD1.5 manifest and images stay as-is.
