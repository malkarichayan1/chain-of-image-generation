...
blocks the discriminant-validity question CLAUDE.md flags: is `predicted_owner` tracking
box size/position rather than attention content? This closes that gap without a Kaggle
