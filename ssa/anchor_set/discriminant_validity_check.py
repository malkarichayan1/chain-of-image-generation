...
attention content? This was previously unresolved, since it "cannot yet be separated from a
...
that reads them, mirroring experiments/discriminant_validity_check.py's approach
...
if __name__ == "__main__":
    ...
    ap.add_argument("--margin-threshold", type=float, default=0.02)
    args = ap.parse_args()
    ...
    rows = build_agreement_rows(manifest, labels, margin_threshold=args.margin_threshold)
