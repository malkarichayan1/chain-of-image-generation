...
question. This directly tests whether the open sub-chance n=2/n=3 result (CLAUDE.md) was just an
...
already in the manifest (see docs/part-a-five-experiment-battery-design.md, Experiment 2). This
script degrades gracefully (prints "unavailable", does not crash) when that field is missing, so
...
UNAVAILABLE_MESSAGE = (
    ...
    "experiment can run -- see docs/part-a-five-experiment-battery-design.md, Experiment 2.")
